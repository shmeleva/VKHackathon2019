...
const axios_url = axios_url_local;

const recommended_goals = {
  no_sugar: {
    title: 'День без сладкого',
    description: 'Быстрые углеводы не приносят пользы, но способствуют увеличению веса. Контроль веса — один из ключевых способов снижения риска развития инсульта.',
    'period': 30,
  },
  no_smoking: {
